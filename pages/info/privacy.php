...
<head>
    ...
    <title>Политика конфиденциальности - RYUO</title>
</head>
    ...
    <div class="min-h-screen flex flex-col">
        <main class="flex-1 py-10">
            <div class="container mx-auto px-4 md:px-0">
                <h1 class="text-3xl font-bold text-gray-800 mb-8 text-center">Политика в отношении обработки персональных данных</h1>
                    <div class="px-4 md:px-0">
                        ...
                        <h1 class="uppercase text-2xl font-bold text-gray-800">ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ</h1>
                    </div>

                <section class=" mt-6">
                    <div class="bg-white p-8 rounded-lg shadow-md border border-gray-200">
                        <div class="space-y-6 text-gray-600">
                            <h2 class="text-2xl font-semibold text-gray-700 mb-6 border-b-2 border-gray-200 pb-2">1. Общие положения</h2>
                            <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые ИП Алькади Мустафа Синан (далее — Оператор).</p>
                            <p>1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.</p>
                            <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://ryuo.store" class="text-blue-600 hover:underline">https://ryuo.store</a>.</p>

                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">2. Основные понятия, используемые в Политике</h2>
                            <div class="space-y-4 pl-6">
                                ...
                                <p>2.3. <strong>Веб-сайт</strong> — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://ryuo.store" class="text-blue-600 hover:underline">https://ryuo.store</a>.</p>
                                ...
                                <p>2.8. <strong>Персональные данные</strong> — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="https://ryuo.store" class="text-blue-600 hover:underline">https://ryuo.store</a>.</p>
                                ...
                                <p>2.10. <strong>Пользователь</strong> — любой посетитель веб-сайта <a href="https://ryuo.store" class="text-blue-600 hover:underline">https://ryuo.store</a>.</p>
                            ...
                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">3. Основные права и обязанности Оператора</h2>
                            <div class="space-y-4 pl-6">
                                <h3 class="text-xl font-semibold text-gray-700 mb-2">3.1. Оператор имеет право:</h3>
                                ...
                                <h3 class="text-xl font-semibold text-gray-700 mb-2 mt-6">3.2. Оператор обязан:</h3>
                                <ul class="list-disc pl-6 space-y-3">
                            ...
                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">4. Основные права и обязанности субъектов персональных данных</h2>
                            <div class="space-y-4 pl-6">
                                <h3 class="text-xl font-semibold text-gray-700 mb-2">4.1. Субъекты персональных данных имеют право:</h3>
                                <ul class="list-disc pl-6 space-y-3">
                                ...
                                <h3 class="text-xl font-semibold text-gray-700 mb-2 mt-6">4.2. Субъекты персональных данных обязаны:</h3>
                                <ul class="list-disc pl-6 space-y-3">
                                    <li>— предоставлять Оператору достоверные данные о себе;</li>
                                    <li>— сообщать Оператору об уточнении (обновлении, изменении) своих персональных данных.</li>
                                </ul>

                                <h3 class="text-xl font-semibold text-gray-700 mb-2 mt-6">4.3. Лица, передавшие Оператору недостоверные сведения о себе, либо сведения о другом субъекте персональных данных без согласия последнего, несут ответственность в соответствии с законодательством РФ.</h3>
                            </div>

                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">5. Принципы обработки персональных данных</h2>
                            <div class="space-y-4 pl-6">
                            ...
                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">6. Цели обработки персональных данных</h2>
                            <div class="space-y-4 pl-6">
                                <p><strong>Цель обработки</strong></p>
                                <p class="pl-6">предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте</p>
                                <p><strong>Персональные данные</strong></p>
                                <p class="pl-6">фамилия, имя, отчество; электронный адрес; номера телефонов; год, месяц, дата и место рождения; адрес фактического места проживания и регистрации по месту жительства и/или по месту пребывания</p>
                                <p><strong>Правовые основания</strong></p>
                                <p class="pl-6">договоры, заключаемые между оператором и субъектом персональных данных</p>
                                <p><strong>Виды обработки персональных данных</strong></p>
                                <p class="pl-6">Отправка информационных писем и рассылок с актуальными предложениями на адрес электронной почты</p>
                            </div>

                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">7. Условия обработки персональных данных</h2>
                            <div class="space-y-4 pl-6">
                            ...
                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">8. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
                            <div class="space-y-4 pl-6">
                                ...
                                <p>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <a href="mailto:e-com@ryuo.store" class="text-blue-600 hover:underline">e-com@ryuo.store</a> с пометкой «Актуализация персональных данных».</p>
                                <p>8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством. Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <a href="mailto:e-com@ryuo.store" class="text-blue-600 hover:underline">e-com@ryuo.store</a> с пометкой «Отзыв согласия на обработку персональных данных».</p>
                            ...
                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">9. Перечень действий, производимых Оператором с полученными персональными данными</h2>
                            <div class="space-y-4 pl-6">
                            ...
                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">10. Трансграничная передача персональных данных</h2>
                            <div class="space-y-4 pl-6">
                            ...
                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">11. Конфиденциальность персональных данных</h2>
                            <div class="space-y-4 pl-6">
                                <p>Оператор и иные лица, получившие доступ к персональным данным, обязаны не раскрывать третьим лицам и не распространять персональные данные без согласия субъекта персональных данных, если иное не предусмотрено федеральным законом.</p>
                            </div>

                            <h2 class="text-2xl font-semibold text-gray-700 mt-10 mb-6 border-b-2 border-gray-200 pb-2">12. Заключительные положения</h2>
                            <div class="space-y-4 pl-6">
                                <p>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a href="mailto:e-com@ryuo.store" class="text-blue-600 hover:underline">e-com@ryuo.store</a>.</p>
                                ...
                                <p>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://ryuo.store/privacy" class="text-blue-600 hover:underline">https://ryuo.store/privacy</a>.</p>
                            </div>
                        </div>
                    </div>
                </section>
